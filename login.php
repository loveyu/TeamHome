...
get_header(['title'  => '登录', 'link' => [['rel' => 'stylesheet', 'type' => 'text/css', 'href' => 'style.css']],
            'script' => [['type' => "text/javascript", "src" => site_url()."js/login_verify.js"]],
]);
?>
      ...
      <div id="login">
        ...
        <form id="loginForm" action="<?php echo site_url("login.php"); ?>" method="post">
          ...
          <input type="hidden" name="redirect_to"
                 value="<?php echo (GET('redirect') != '') ? urldecode(GET('redirect')) : $_SERVER['HTTP_REFERER']; ?>"/>
        </form>
      </div>
    </div>
