...
class PHPMailer
{
    ...
    protected function PreSend()
    {
        try {
            ...
            if ($this->DKIM_domain && $this->DKIM_private) {
                $header_dkim =
                    $this->DKIM_Add($this->MIMEHeader, $this->EncodeHeader($this->SecureHeader($this->Subject)),
                        $this->MIMEBody);
    ...
    function SetLanguage($langcode = 'en', $lang_path = 'language/')
    {
        ...
        $PHPMAILER_LANG =
            [
                ...
                'mailer_not_supported' => ' mailer is not supported.', 'execute' => 'Could not execute: ',
                ...
                'smtp_error'           => 'SMTP server error: ', 'empty_message' => 'Message body empty',
    ...
    protected function AttachAll($disposition_type, $boundary)
    {
        ...
        foreach ($this->attachment as $attachment) {
            ...
            if ($attachment[6] == $disposition_type) {
                ...
                $mime[] =
                    sprintf("Content-Type: %s; name=\"%s\"%s", $type, $this->EncodeHeader($this->SecureHeader($name)),
                        $this->LE);
                ...
                $mime[] =
                    sprintf("Content-Disposition: %s; filename=\"%s\"%s", $disposition,
    ...
    public function AddStringAttachment($string, $filename, $encoding = 'base64', $type = 'application/octet-stream')
    {
        ...
        $this->attachment[] = [
            0 => $string, 1 => $filename, 2 => basename($filename), 3 => $encoding, 4 => $type, 5 => true,
            // isStringAttachment
            6 => 'attachment', 7 => 0,
        ];
    }
            ...
            foreach ($images[2] as $i => $url) {
                ...
                if (!preg_match('#^[A-z]+://#', $url)) {
                    ...
                    if ($this->AddEmbeddedImage($basedir.$directory.$filename, md5($filename), $filename, 'base64',
                        $mimeType)) {
                        $message =
                            preg_replace("/".$images[1][$i]."=\"".preg_quote($url, '/')."\"/Ui",
    ...
    public static function _mime_types($ext = '')
    {
        $mimes = [
            ...
            'psd'   => 'application/octet-stream', 'so' => 'application/octet-stream',
    ...
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $dkimhdrs =
            "DKIM-Signature: v=1; a=".$DKIMsignatureType."; q=".$DKIMquery."; l=".$DKIMlen."; s=".$this->DKIM_selector.";\r\n"."\tt=".$DKIMtime."; c=".$DKIMcanonicalization.";\r\n"."\th=From:To:Subject;\r\n"."\td=".$this->DKIM_domain.";".$ident."\r\n"."\tz=$from\r\n"."\t|$to\r\n"."\t|$subject;\r\n"."\tbh=".$DKIMb64.";\r\n"."\tb=";
