...
$zxtmp->add_admin_menu(//增加一个菜单
	...
	array(),
	array(
		array('url'=>'#','name'=>'创建新分类','id'=>'category_new','power'=>array(0))
	)
);
$cat = $zxcat;
...
<table>
<label><tr><th>分类名称:</th><td><input name="name" value="" type="text" /></td></tr></label>
<label><tr><th>别名:</th><td><input name="alias" value="" type="text" /><span>必须为英文及数字</span></td></tr></label>
<label><tr valign="top"><th>描述:</th><td><textarea name="description"></textarea></td></tr></label>
