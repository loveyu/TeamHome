      ...
      <tr>
        ...
        <td class="td4">
          ...
          <table class="sub_table">
            ...
            <tr>
              <th>权限</th>
              <td><?php $power_list = $zxuser->get_power_group();
                  echo $power_list[get_power()];
                  unset($power_list) ?></td>
            </tr>
            <tr>
              <th>头像</th>
              <td><img src="<?php echo get_avata($user->user_info['id']); ?>" height="64" width="64" alt="img"/></td>
            </tr>
            <tr>
              <td colspan="2">&nbsp;</td>
            </tr>
