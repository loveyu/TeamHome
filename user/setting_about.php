...
$about_info = array('team_about'=>$zxsys->get_setting('team_about'),'team_proclamation'=>$zxsys->get_setting('team_proclamation'));
...
<p>团队简介:</p>
<textarea name="team_about" style="width:99.8%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($about_info['team_about'])?></textarea>
</div>
<div class="team_about">
<p>公告栏:</p>
<textarea name="team_proclamation" style="width:99.8%;height:200px;visibility:hidden;"><?php echo htmlspecialchars($about_info['team_proclamation'])?></textarea>
</div>
