...
send_header();
if(!is_admin())forbid_page();//非管理员禁止访问
...
if(is_post()){
	...
	if($err=='OK')redirect(site_url('user/user_manage_restpwd.php?type=OK&id='.POST('id')),'refresh');
}
...
<div id="user_manage">
<h3>重置用户密码</h3>
<?php if($err)echo "<p class=\"notice\">$err</p>\n";?>
