...
if ($err == 'OK') {
    redirect(site_url('login.php?notice='.urlencode("你的密码已修改，请重新登录")), 'refresh');
}
get_admin_header([
    'title'  => '修改个人密码',
    'link'   => [
    ...
    'script' => [
        ...
        ['src' => site_url('js/user_center_chage_pwd_verify.js'), 'type' => "text/javascript"],
    ],
]);
?>
  <div id="user_center">
    ...
    <form class="edit_pwd" id="user_change_pwd" action="edit_pwd.php" method="post">
      ...
      <div>
        <ul>
          ...
          <li><label for="old_pwd">原始密码:</label><br/><input id="old_pwd" name="pwd" type="password" value=""/><span
              id="old_info"></span></li>
          <li><label for="new_pwd">新密码:</label><br/><input id="new_pwd" name="new" type="password" value=""/><span
              id="new_info"></span></li>
          <li><label for="confirm_pwd">确认新密码:</label><br/><input id="confirm_pwd" name="confirm" type="password"
                                                                 value=""/><span id="confirm_info"></span></li>
          <li>
