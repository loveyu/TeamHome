...
<table class="new">
<tr><th>组名:</th><td><input name="name" value="" type="text" /></td></tr>
<tr><th>组长ID:</th><td><input name="lader" value="" type="text" /></td></tr>
...
<tr><td colspan="2"><button class="submit" type="submit">创建分组</button></td></tr>
</table>
</form>
</div>
