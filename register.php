...
get_header(['title'  => '用户注册', 'link' => [['rel' => 'stylesheet', 'type' => 'text/css', 'href' => 'style.css']],
            'script' => [['type' => "text/javascript", "src" => site_url()."js/register_verify.js"]],
]);
?>
      ...
      <div id="register">
        <h2>用户注册</h2>
          <?php if (!allow_register()) {
            ...
            <form name="register_table" id="RegisterForm" action="<?php echo site_url("registering.php"); ?>"
                  method="post">
              <div>
