...
<style type="text/css">
	#PCOUNT_SEARCH{text-align:left;background-color:#FAF7ED;padding:10px;}
	#PCOUNT_SEARCH h3{font-size:17px;line-height:40px;color:#336;}
	#PCOUNT_SEARCH label{display:block;margin:4px 0px;}
	#PCOUNT_SEARCH input{display:block;margin:2px;}
	#PCOUNT_SEARCH button{padding:5px 10px;margin:4px;}
	#PCOUNT_SEARCH p.notice{border:#666 solid 1px;background:#D8F5B6;font-size:17px;margin:5px 0;padding:4px;}
</style>
