<?php if(!defined('ROOT_PATH'))
	...
	function PHome_add_admin_menu(){
		global $zxtmp;
		$zxtmp->add_admin_menu('setting-center', array(), array(array('url' => 'plugin_page.php?m=setting&id=home&p=setting', 'name' => 'URL伪静态设置', 'id' => 'setting_PHome', 'power' => array(0))));
	}
	...
	function PHome_load($PHome_name, $PHome_param = array()){
		...
		else require_once(ROOT_PATH . "home/" . $PHome_name . ".php");
	}
